...
from .....types.prism.objects.identities import grant_update_params
from .....types.prism.objects.identities.grant_get_response import GrantGetResponse
from .....types.prism.objects.identities.grant_update_response import GrantUpdateResponse
...
class GrantResource(SyncAPIResource):
    ...
    def update(
        ...
        *,
        ...
        return self._put(
            path_template(
                "/v2/prism/grant/{path_team_id}/identity/{identity_id}",
    ...
    def get(
        ...
        *,
        ...
        if not identity_id:
            raise ValueError(f"Expected a non-empty value for `identity_id` but received {identity_id!r}")
        return self._get(
            path_template("/v2/prism/grant/{team_id}/identity/{identity_id}", team_id=team_id, identity_id=identity_id),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
