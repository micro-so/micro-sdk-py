...
from .....types.prism.objects import (
    ...
    action_upsert_params,
    action_bulk_create_params,
    action_bulk_delete_params,
    action_bulk_update_params,
)
from .....types.prism_object_properties_param import PrismObjectPropertiesParam
from .....types.prism.objects.action_get_response import ActionGetResponse
from .....types.prism.objects.action_find_response import ActionFindResponse
from .....types.prism.objects.action_list_response import ActionListResponse
from .....types.prism.objects.action_count_response import ActionCountResponse
from .....types.prism.objects.action_query_response import ActionQueryResponse
from .....types.prism.objects.action_create_response import ActionCreateResponse
from .....types.prism.objects.action_update_response import ActionUpdateResponse
from .....types.prism.objects.action_upsert_response import ActionUpsertResponse
from .....types.prism.objects.action_restore_response import ActionRestoreResponse
from .....types.prism.objects.action_duplicate_response import ActionDuplicateResponse
from .....types.prism.objects.action_bulk_create_response import ActionBulkCreateResponse
from .....types.prism.objects.action_bulk_delete_response import ActionBulkDeleteResponse
from .....types.prism.objects.action_bulk_update_response import ActionBulkUpdateResponse
...
class ActionsResource(SyncAPIResource):
    ...
    def create(
        ...
        *,
        ...
        For `document`, writing `content` (or HTML) stores the
    ...
    def bulk_create(
        ...
        *,
        ...
        options: action_bulk_create_params.Options | Omit = omit,
        idempotency_key: str | Omit = omit,
        # Use the following arguments if you need to pass additional parameters to the API that aren't available via kwargs.
        # The extra values given here take precedence over values defined on the client or passed to this method.
        extra_headers: Headers | None = None,
        ...
        extra_headers = {**strip_not_given({"Idempotency-Key": idempotency_key}), **(extra_headers or {})}
        return self._post(
            path_template("/v2/prism/{team_id}/action/import", team_id=team_id),
            body=maybe_transform(
                {
                    "objects": objects,
                    "options": options,
                },
                action_bulk_create_params.ActionBulkCreateParams,
            ),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=ActionBulkCreateResponse,
        )
    ...
    def bulk_delete(
        ...
        *,
        ...
        extra_headers = {**strip_not_given({"Idempotency-Key": idempotency_key}), **(extra_headers or {})}
        return self._post(
            path_template("/v2/prism/{team_id}/action/batch/delete", team_id=team_id),
            body=maybe_transform({"ids": ids}, action_bulk_delete_params.ActionBulkDeleteParams),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=ActionBulkDeleteResponse,
        )
    ...
    def bulk_update(
        ...
        *,
        team_id: str | None = None,
        items: Iterable[action_bulk_update_params.Item],
        idempotency_key: str | Omit = omit,
        # Use the following arguments if you need to pass additional parameters to the API that aren't available via kwargs.
        # The extra values given here take precedence over values defined on the client or passed to this method.
        extra_headers: Headers | None = None,
        ...
        extra_headers = {**strip_not_given({"Idempotency-Key": idempotency_key}), **(extra_headers or {})}
        return self._post(
            path_template("/v2/prism/{team_id}/action/batch/update", team_id=team_id),
            body=maybe_transform({"items": items}, action_bulk_update_params.ActionBulkUpdateParams),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=ActionBulkUpdateResponse,
        )
    ...
    def count(
        ...
        *,
        ...
        if not team_id:
            raise ValueError(f"Expected a non-empty value for `team_id` but received {team_id!r}")
        return self._get(
            path_template("/v2/prism/{team_id}/action/count", team_id=team_id),
            options=make_request_options(
                extra_headers=extra_headers,
                extra_query=extra_query,
                extra_body=extra_body,
                timeout=timeout,
                query=maybe_transform({"list_id": list_id}, action_count_params.ActionCountParams),
            ),
            cast_to=ActionCountResponse,
        )
    ...
    def duplicate(
        ...
        *,
        ...
        extra_headers = {**strip_not_given({"Idempotency-Key": idempotency_key}), **(extra_headers or {})}
        return self._post(
            path_template("/v2/prism/{team_id}/action/{action_id}/duplicate", team_id=team_id, action_id=action_id),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=ActionDuplicateResponse,
        )
    ...
    def find(
        ...
        *,
        ...
        return self._get(
            path_template("/v2/prism/{team_id}/action/by/{slug}/{value}", team_id=team_id, slug=slug, value=value),
            options=make_request_options(
                extra_headers=extra_headers,
                extra_query=extra_query,
                extra_body=extra_body,
                timeout=timeout,
                query=maybe_transform({"list_id": list_id}, action_find_params.ActionFindParams),
            ),
            cast_to=ActionFindResponse,
        )
        ...
        *,
        ...
        return self._get(
            ...
            options=make_request_options(
                ...
                extra_body=extra_body,
                timeout=timeout,
                query=maybe_transform({"select": select}, action_get_params.ActionGetParams),
            ),
            cast_to=ActionGetResponse,
        )
    ...
    def query(
        ...
        *,
        team_id: str | None = None,
        query: action_query_params.Query,
        ...
        extra_headers = {**strip_not_given({"Idempotency-Key": idempotency_key}), **(extra_headers or {})}
        return self._post(
            path_template("/v2/prism/{team_id}/action/query", team_id=team_id),
            body=maybe_transform(
                {
                    "query": query,
                    "id": id,
    ...
    def restore(
        ...
        *,
        ...
        extra_headers = {**strip_not_given({"Idempotency-Key": idempotency_key}), **(extra_headers or {})}
        return self._post(
            path_template("/v2/prism/{team_id}/action/{action_id}/restore", team_id=team_id, action_id=action_id),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=ActionRestoreResponse,
        )
        ...
        *,
        ...
        return self._put(
            ...
            body=maybe_transform(
                ...
                action_upsert_params.ActionUpsertParams,
            ),
            options=make_request_options(
                extra_headers=extra_headers,
                extra_query=extra_query,
                extra_body=extra_body,
                timeout=timeout,
                query=maybe_transform({"list_id": list_id}, action_upsert_params.ActionUpsertParams),
            ),
            cast_to=ActionUpsertResponse,
        )
...
class AsyncActionsResource(AsyncAPIResource):
    ...
    async def bulk_delete(
        ...
        *,
        ...
        return await self._post(
            path_template("/v2/prism/{team_id}/action/batch/delete", team_id=team_id),
            body=await async_maybe_transform({"ids": ids}, action_bulk_delete_params.ActionBulkDeleteParams),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=ActionBulkDeleteResponse,
    ...
    async def bulk_update(
        ...
        *,
        ...
        return await self._post(
            path_template("/v2/prism/{team_id}/action/batch/update", team_id=team_id),
            body=await async_maybe_transform({"items": items}, action_bulk_update_params.ActionBulkUpdateParams),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=ActionBulkUpdateResponse,
        ...
        *,
        ...
        return await self._get(
            ...
            options=make_request_options(
                ...
                extra_body=extra_body,
                timeout=timeout,
                query=await async_maybe_transform({"list_id": list_id}, action_count_params.ActionCountParams),
            ),
            cast_to=ActionCountResponse,
        )
        ...
        *,
        ...
        return await self._get(
            ...
            options=make_request_options(
                ...
                extra_body=extra_body,
                timeout=timeout,
                query=await async_maybe_transform({"list_id": list_id}, action_find_params.ActionFindParams),
            ),
            cast_to=ActionFindResponse,
        )
        ...
        *,
        ...
        return await self._get(
            ...
            options=make_request_options(
                ...
                extra_body=extra_body,
                timeout=timeout,
                query=await async_maybe_transform({"select": select}, action_get_params.ActionGetParams),
            ),
            cast_to=ActionGetResponse,
        )
        ...
        *,
        ...
        return await self._put(
            ...
            options=make_request_options(
                ...
                extra_body=extra_body,
                timeout=timeout,
                query=await async_maybe_transform({"list_id": list_id}, action_upsert_params.ActionUpsertParams),
            ),
            cast_to=ActionUpsertResponse,
        )
...
class ActionsResourceWithRawResponse:
    ...
    def grant(self) -> GrantResourceWithRawResponse:
        return GrantResourceWithRawResponse(self._actions.grant)
...
class AsyncActionsResourceWithRawResponse:
    ...
    def grant(self) -> AsyncGrantResourceWithRawResponse:
        return AsyncGrantResourceWithRawResponse(self._actions.grant)
...
class ActionsResourceWithStreamingResponse:
    ...
    def grant(self) -> GrantResourceWithStreamingResponse:
        return GrantResourceWithStreamingResponse(self._actions.grant)
...
class AsyncActionsResourceWithStreamingResponse:
    ...
    def grant(self) -> AsyncGrantResourceWithStreamingResponse:
        return AsyncGrantResourceWithStreamingResponse(self._actions.grant)
