...
class MessagesResourceWithRawResponse:
    ...
    def grant(self) -> GrantResourceWithRawResponse:
        return GrantResourceWithRawResponse(self._messages.grant)
...
class AsyncMessagesResourceWithRawResponse:
    ...
    def grant(self) -> AsyncGrantResourceWithRawResponse:
        return AsyncGrantResourceWithRawResponse(self._messages.grant)
...
class MessagesResourceWithStreamingResponse:
    ...
    def grant(self) -> GrantResourceWithStreamingResponse:
        return GrantResourceWithStreamingResponse(self._messages.grant)
...
class AsyncMessagesResourceWithStreamingResponse:
    ...
    def grant(self) -> AsyncGrantResourceWithStreamingResponse:
        return AsyncGrantResourceWithStreamingResponse(self._messages.grant)
