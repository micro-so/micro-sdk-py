...
from .....types.prism.objects.engagements import grant_update_params
from .....types.prism.objects.engagements.grant_get_response import GrantGetResponse
from .....types.prism.objects.engagements.grant_update_response import GrantUpdateResponse
...
class GrantResource(SyncAPIResource):
    ...
    def update(
        ...
        *,
        ...
        return self._put(
            path_template(
                "/v2/prism/{path_team_id}/engagement/{engagement_id}/grant",
    ...
    def get(
        ...
        *,
        ...
        return self._get(
            path_template(
                "/v2/prism/{team_id}/engagement/{engagement_id}/grant", team_id=team_id, engagement_id=engagement_id
            ),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
