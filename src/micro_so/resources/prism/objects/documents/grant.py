...
from .....types.prism.objects.documents import grant_update_params
from .....types.prism.objects.documents.grant_get_response import GrantGetResponse
from .....types.prism.objects.documents.grant_update_response import GrantUpdateResponse
...
class GrantResource(SyncAPIResource):
    ...
    def update(
        ...
        *,
        ...
        return self._put(
            path_template(
                "/v2/prism/{path_team_id}/document/{document_id}/grant",
    ...
    def get(
        ...
        *,
        ...
        if not document_id:
            raise ValueError(f"Expected a non-empty value for `document_id` but received {document_id!r}")
        return self._get(
            path_template("/v2/prism/{team_id}/document/{document_id}/grant", team_id=team_id, document_id=document_id),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
