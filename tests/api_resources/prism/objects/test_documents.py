...
class TestDocuments:
    ...
    def test_method_list(self, client: Micro) -> None:
        document = client.prism.objects.documents.list()
    ...
    def test_raw_response_list(self, client: Micro) -> None:
        response = client.prism.objects.documents.with_raw_response.list()
    ...
    def test_streaming_response_list(self, client: Micro) -> None:
        with client.prism.objects.documents.with_streaming_response.list() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_method_bulk_delete(self, client: Micro) -> None:
        document = client.prism.objects.documents.bulk_delete(
            ids=["182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e"],
        )
        assert_matches_type(DocumentBulkDeleteResponse, document, path=["response"])
    ...
    def test_raw_response_bulk_delete(self, client: Micro) -> None:
        response = client.prism.objects.documents.with_raw_response.bulk_delete(
            ids=["182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e"],
        )
    ...
    def test_streaming_response_bulk_delete(self, client: Micro) -> None:
        with client.prism.objects.documents.with_streaming_response.bulk_delete(
            ids=["182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e"],
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_method_bulk_update(self, client: Micro) -> None:
        document = client.prism.objects.documents.bulk_update(
            items=[{"id": "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e"}],
        )
        assert_matches_type(DocumentBulkUpdateResponse, document, path=["response"])
    ...
    def test_raw_response_bulk_update(self, client: Micro) -> None:
        response = client.prism.objects.documents.with_raw_response.bulk_update(
            items=[{"id": "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e"}],
        )
    ...
    def test_streaming_response_bulk_update(self, client: Micro) -> None:
        with client.prism.objects.documents.with_streaming_response.bulk_update(
            items=[{"id": "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e"}],
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_method_count(self, client: Micro) -> None:
        document = client.prism.objects.documents.count()
    ...
    def test_raw_response_count(self, client: Micro) -> None:
        response = client.prism.objects.documents.with_raw_response.count()
    ...
    def test_streaming_response_count(self, client: Micro) -> None:
        with client.prism.objects.documents.with_streaming_response.count() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_method_find(self, client: Micro) -> None:
        document = client.prism.objects.documents.find(
            value="value",
            slug="slug",
        )
        assert_matches_type(DocumentFindResponse, document, path=["response"])
    ...
    def test_raw_response_find(self, client: Micro) -> None:
        response = client.prism.objects.documents.with_raw_response.find(
            value="value",
            slug="slug",
        )
    ...
    def test_streaming_response_find(self, client: Micro) -> None:
        with client.prism.objects.documents.with_streaming_response.find(
            value="value",
            slug="slug",
        ) as response:
            assert not response.is_closed
    ...
    def test_path_params_find(self, client: Micro) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `slug` but received ''"):
            client.prism.objects.documents.with_raw_response.find(
                value="value",
                slug="",
            )
    ...
    def test_raw_response_upsert(self, client: Micro) -> None:
        response = client.prism.objects.documents.with_raw_response.upsert(
            value="value",
            slug="slug",
        )
    ...
    def test_streaming_response_upsert(self, client: Micro) -> None:
        with client.prism.objects.documents.with_streaming_response.upsert(
            value="value",
            slug="slug",
        ) as response:
            assert not response.is_closed
    ...
    def test_path_params_upsert(self, client: Micro) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `slug` but received ''"):
            client.prism.objects.documents.with_raw_response.upsert(
                value="value",
                slug="",
            )
...
class TestAsyncDocuments:
    ...
    async def test_method_list(self, async_client: AsyncMicro) -> None:
        document = await async_client.prism.objects.documents.list()
        assert_matches_type(DocumentListResponse, document, path=["response"])
    ...
    async def test_raw_response_list(self, async_client: AsyncMicro) -> None:
        response = await async_client.prism.objects.documents.with_raw_response.list()
    ...
    async def test_streaming_response_list(self, async_client: AsyncMicro) -> None:
        async with async_client.prism.objects.documents.with_streaming_response.list() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_method_bulk_delete(self, async_client: AsyncMicro) -> None:
        document = await async_client.prism.objects.documents.bulk_delete(
            ids=["182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e"],
        )
        assert_matches_type(DocumentBulkDeleteResponse, document, path=["response"])
    ...
    async def test_raw_response_bulk_delete(self, async_client: AsyncMicro) -> None:
        response = await async_client.prism.objects.documents.with_raw_response.bulk_delete(
            ids=["182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e"],
        )
    ...
    async def test_streaming_response_bulk_delete(self, async_client: AsyncMicro) -> None:
        async with async_client.prism.objects.documents.with_streaming_response.bulk_delete(
            ids=["182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e"],
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_method_bulk_update(self, async_client: AsyncMicro) -> None:
        document = await async_client.prism.objects.documents.bulk_update(
            items=[{"id": "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e"}],
        )
        assert_matches_type(DocumentBulkUpdateResponse, document, path=["response"])
    ...
    async def test_raw_response_bulk_update(self, async_client: AsyncMicro) -> None:
        response = await async_client.prism.objects.documents.with_raw_response.bulk_update(
            items=[{"id": "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e"}],
        )
    ...
    async def test_streaming_response_bulk_update(self, async_client: AsyncMicro) -> None:
        async with async_client.prism.objects.documents.with_streaming_response.bulk_update(
            items=[{"id": "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e"}],
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_method_count(self, async_client: AsyncMicro) -> None:
        document = await async_client.prism.objects.documents.count()
        assert_matches_type(DocumentCountResponse, document, path=["response"])
    ...
    async def test_raw_response_count(self, async_client: AsyncMicro) -> None:
        response = await async_client.prism.objects.documents.with_raw_response.count()
    ...
    async def test_streaming_response_count(self, async_client: AsyncMicro) -> None:
        async with async_client.prism.objects.documents.with_streaming_response.count() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_method_find(self, async_client: AsyncMicro) -> None:
        document = await async_client.prism.objects.documents.find(
            value="value",
            slug="slug",
        )
        assert_matches_type(DocumentFindResponse, document, path=["response"])
    ...
    async def test_raw_response_find(self, async_client: AsyncMicro) -> None:
        response = await async_client.prism.objects.documents.with_raw_response.find(
            value="value",
            slug="slug",
        )
    ...
    async def test_streaming_response_find(self, async_client: AsyncMicro) -> None:
        async with async_client.prism.objects.documents.with_streaming_response.find(
            value="value",
            slug="slug",
        ) as response:
            assert not response.is_closed
    ...
    async def test_path_params_find(self, async_client: AsyncMicro) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `slug` but received ''"):
            await async_client.prism.objects.documents.with_raw_response.find(
                value="value",
                slug="",
            )
    ...
    async def test_raw_response_upsert(self, async_client: AsyncMicro) -> None:
        response = await async_client.prism.objects.documents.with_raw_response.upsert(
            value="value",
            slug="slug",
        )
    ...
    async def test_streaming_response_upsert(self, async_client: AsyncMicro) -> None:
        async with async_client.prism.objects.documents.with_streaming_response.upsert(
            value="value",
            slug="slug",
        ) as response:
            assert not response.is_closed
    ...
    async def test_path_params_upsert(self, async_client: AsyncMicro) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `slug` but received ''"):
            await async_client.prism.objects.documents.with_raw_response.upsert(
                value="value",
                slug="",
            )
