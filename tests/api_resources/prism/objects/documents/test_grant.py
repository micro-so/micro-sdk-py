...
from micro_so.types.prism.objects.documents import GrantGetResponse, GrantUpdateResponse
...
class TestGrant:
    ...
    def test_raw_response_update(self, client: Micro) -> None:
        response = client.prism.objects.documents.grant.with_raw_response.update(
            document_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
    ...
    def test_streaming_response_update(self, client: Micro) -> None:
        with client.prism.objects.documents.grant.with_streaming_response.update(
            document_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        ) as response:
    ...
    def test_path_params_update(self, client: Micro) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `document_id` but received ''"):
            client.prism.objects.documents.grant.with_raw_response.update(
                document_id="",
            )
    ...
    def test_raw_response_get(self, client: Micro) -> None:
        response = client.prism.objects.documents.grant.with_raw_response.get(
            document_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
    ...
    def test_streaming_response_get(self, client: Micro) -> None:
        with client.prism.objects.documents.grant.with_streaming_response.get(
            document_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_path_params_get(self, client: Micro) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `document_id` but received ''"):
            client.prism.objects.documents.grant.with_raw_response.get(
                document_id="",
            )
...
class TestAsyncGrant:
    ...
    async def test_raw_response_update(self, async_client: AsyncMicro) -> None:
        response = await async_client.prism.objects.documents.grant.with_raw_response.update(
            document_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
    ...
    async def test_streaming_response_update(self, async_client: AsyncMicro) -> None:
        async with async_client.prism.objects.documents.grant.with_streaming_response.update(
            document_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_update(self, async_client: AsyncMicro) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `document_id` but received ''"):
            await async_client.prism.objects.documents.grant.with_raw_response.update(
                document_id="",
            )
    ...
    async def test_method_get(self, async_client: AsyncMicro) -> None:
        grant = await async_client.prism.objects.documents.grant.get(
            document_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
        assert_matches_type(GrantGetResponse, grant, path=["response"])
    ...
    async def test_raw_response_get(self, async_client: AsyncMicro) -> None:
        response = await async_client.prism.objects.documents.grant.with_raw_response.get(
            document_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
    ...
    async def test_streaming_response_get(self, async_client: AsyncMicro) -> None:
        async with async_client.prism.objects.documents.grant.with_streaming_response.get(
            document_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_get(self, async_client: AsyncMicro) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `document_id` but received ''"):
            await async_client.prism.objects.documents.grant.with_raw_response.get(
                document_id="",
            )
