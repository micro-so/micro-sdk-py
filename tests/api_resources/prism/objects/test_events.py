...
class TestEvents:
    ...
    def test_method_list(self, client: Micro) -> None:
        event = client.prism.objects.events.list()
    ...
    def test_raw_response_list(self, client: Micro) -> None:
        response = client.prism.objects.events.with_raw_response.list()
    ...
    def test_streaming_response_list(self, client: Micro) -> None:
        with client.prism.objects.events.with_streaming_response.list() as response:
    ...
    def test_raw_response_count(self, client: Micro) -> None:
        response = client.prism.objects.events.with_raw_response.count()
    ...
    def test_streaming_response_count(self, client: Micro) -> None:
        with client.prism.objects.events.with_streaming_response.count() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_method_find(self, client: Micro) -> None:
        event = client.prism.objects.events.find(
            value="value",
            slug="slug",
        )
        assert_matches_type(EventFindResponse, event, path=["response"])
    ...
    def test_raw_response_find(self, client: Micro) -> None:
        response = client.prism.objects.events.with_raw_response.find(
            value="value",
            slug="slug",
        )
    ...
    def test_streaming_response_find(self, client: Micro) -> None:
        with client.prism.objects.events.with_streaming_response.find(
            value="value",
            slug="slug",
        ) as response:
            assert not response.is_closed
    ...
    def test_path_params_find(self, client: Micro) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `slug` but received ''"):
            client.prism.objects.events.with_raw_response.find(
                value="value",
                slug="",
            )
...
class TestAsyncEvents:
    ...
    async def test_method_list(self, async_client: AsyncMicro) -> None:
        event = await async_client.prism.objects.events.list()
        assert_matches_type(EventListResponse, event, path=["response"])
    ...
    async def test_raw_response_list(self, async_client: AsyncMicro) -> None:
        response = await async_client.prism.objects.events.with_raw_response.list()
    ...
    async def test_streaming_response_list(self, async_client: AsyncMicro) -> None:
        async with async_client.prism.objects.events.with_streaming_response.list() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_raw_response_count(self, async_client: AsyncMicro) -> None:
        response = await async_client.prism.objects.events.with_raw_response.count()
    ...
    async def test_streaming_response_count(self, async_client: AsyncMicro) -> None:
        async with async_client.prism.objects.events.with_streaming_response.count() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_method_find(self, async_client: AsyncMicro) -> None:
        event = await async_client.prism.objects.events.find(
            value="value",
            slug="slug",
        )
        assert_matches_type(EventFindResponse, event, path=["response"])
    ...
    async def test_raw_response_find(self, async_client: AsyncMicro) -> None:
        response = await async_client.prism.objects.events.with_raw_response.find(
            value="value",
            slug="slug",
        )
    ...
    async def test_streaming_response_find(self, async_client: AsyncMicro) -> None:
        async with async_client.prism.objects.events.with_streaming_response.find(
            value="value",
            slug="slug",
        ) as response:
            assert not response.is_closed
    ...
    async def test_path_params_find(self, async_client: AsyncMicro) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `slug` but received ''"):
            await async_client.prism.objects.events.with_raw_response.find(
                value="value",
                slug="",
            )
