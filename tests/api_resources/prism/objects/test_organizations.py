...
class TestOrganizations:
    ...
    def test_raw_response_update(self, client: Micro) -> None:
        response = client.prism.objects.organizations.with_raw_response.update(
            organization_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
    ...
    def test_streaming_response_update(self, client: Micro) -> None:
        with client.prism.objects.organizations.with_streaming_response.update(
            organization_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_path_params_update(self, client: Micro) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `organization_id` but received ''"):
            client.prism.objects.organizations.with_raw_response.update(
                organization_id="",
            )
    ...
    def test_method_list(self, client: Micro) -> None:
        organization = client.prism.objects.organizations.list()
    ...
    def test_raw_response_list(self, client: Micro) -> None:
        response = client.prism.objects.organizations.with_raw_response.list()
    ...
    def test_streaming_response_list(self, client: Micro) -> None:
        with client.prism.objects.organizations.with_streaming_response.list() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_method_delete(self, client: Micro) -> None:
        organization = client.prism.objects.organizations.delete(
            organization_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
    ...
    def test_raw_response_delete(self, client: Micro) -> None:
        response = client.prism.objects.organizations.with_raw_response.delete(
            organization_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
    ...
    def test_streaming_response_delete(self, client: Micro) -> None:
        with client.prism.objects.organizations.with_streaming_response.delete(
            organization_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_path_params_delete(self, client: Micro) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `organization_id` but received ''"):
            client.prism.objects.organizations.with_raw_response.delete(
                organization_id="",
            )
    ...
    def test_method_bulk_delete(self, client: Micro) -> None:
        organization = client.prism.objects.organizations.bulk_delete(
            ids=["182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e"],
        )
        assert_matches_type(OrganizationBulkDeleteResponse, organization, path=["response"])
    ...
    def test_raw_response_bulk_delete(self, client: Micro) -> None:
        response = client.prism.objects.organizations.with_raw_response.bulk_delete(
            ids=["182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e"],
        )
    ...
    def test_streaming_response_bulk_delete(self, client: Micro) -> None:
        with client.prism.objects.organizations.with_streaming_response.bulk_delete(
            ids=["182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e"],
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_method_bulk_update(self, client: Micro) -> None:
        organization = client.prism.objects.organizations.bulk_update(
            items=[{"id": "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e"}],
        )
        assert_matches_type(OrganizationBulkUpdateResponse, organization, path=["response"])
    ...
    def test_raw_response_bulk_update(self, client: Micro) -> None:
        response = client.prism.objects.organizations.with_raw_response.bulk_update(
            items=[{"id": "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e"}],
        )
    ...
    def test_streaming_response_bulk_update(self, client: Micro) -> None:
        with client.prism.objects.organizations.with_streaming_response.bulk_update(
            items=[{"id": "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e"}],
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_method_count(self, client: Micro) -> None:
        organization = client.prism.objects.organizations.count()
        assert_matches_type(OrganizationCountResponse, organization, path=["response"])
    ...
    def test_raw_response_count(self, client: Micro) -> None:
        response = client.prism.objects.organizations.with_raw_response.count()
    ...
    def test_streaming_response_count(self, client: Micro) -> None:
        with client.prism.objects.organizations.with_streaming_response.count() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_method_duplicate(self, client: Micro) -> None:
        organization = client.prism.objects.organizations.duplicate(
            organization_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
        assert_matches_type(OrganizationDuplicateResponse, organization, path=["response"])
    ...
    def test_raw_response_duplicate(self, client: Micro) -> None:
        response = client.prism.objects.organizations.with_raw_response.duplicate(
            organization_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
    ...
    def test_streaming_response_duplicate(self, client: Micro) -> None:
        with client.prism.objects.organizations.with_streaming_response.duplicate(
            organization_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_path_params_duplicate(self, client: Micro) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `organization_id` but received ''"):
            client.prism.objects.organizations.with_raw_response.duplicate(
                organization_id="",
            )
    ...
    def test_method_find(self, client: Micro) -> None:
        organization = client.prism.objects.organizations.find(
            value="value",
            slug="slug",
        )
        assert_matches_type(OrganizationFindResponse, organization, path=["response"])
    ...
    def test_raw_response_find(self, client: Micro) -> None:
        response = client.prism.objects.organizations.with_raw_response.find(
            value="value",
            slug="slug",
        )
    ...
    def test_streaming_response_find(self, client: Micro) -> None:
        with client.prism.objects.organizations.with_streaming_response.find(
            value="value",
            slug="slug",
        ) as response:
            assert not response.is_closed
    ...
    def test_path_params_find(self, client: Micro) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `slug` but received ''"):
            client.prism.objects.organizations.with_raw_response.find(
                value="value",
                slug="",
            )
    ...
    def test_raw_response_get(self, client: Micro) -> None:
        response = client.prism.objects.organizations.with_raw_response.get(
            organization_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
    ...
    def test_streaming_response_get(self, client: Micro) -> None:
        with client.prism.objects.organizations.with_streaming_response.get(
            organization_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_path_params_get(self, client: Micro) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `organization_id` but received ''"):
            client.prism.objects.organizations.with_raw_response.get(
                organization_id="",
            )
    ...
    def test_method_restore(self, client: Micro) -> None:
        organization = client.prism.objects.organizations.restore(
            organization_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
        assert_matches_type(OrganizationRestoreResponse, organization, path=["response"])
    ...
    def test_raw_response_restore(self, client: Micro) -> None:
        response = client.prism.objects.organizations.with_raw_response.restore(
            organization_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
    ...
    def test_streaming_response_restore(self, client: Micro) -> None:
        with client.prism.objects.organizations.with_streaming_response.restore(
            organization_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_path_params_restore(self, client: Micro) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `organization_id` but received ''"):
            client.prism.objects.organizations.with_raw_response.restore(
                organization_id="",
            )
    ...
    def test_method_upsert(self, client: Micro) -> None:
        organization = client.prism.objects.organizations.upsert(
            value="value",
            slug="slug",
        )
        assert_matches_type(OrganizationUpsertResponse, organization, path=["response"])
    ...
    def test_raw_response_upsert(self, client: Micro) -> None:
        response = client.prism.objects.organizations.with_raw_response.upsert(
            value="value",
            slug="slug",
        )
    ...
    def test_streaming_response_upsert(self, client: Micro) -> None:
        with client.prism.objects.organizations.with_streaming_response.upsert(
            value="value",
            slug="slug",
        ) as response:
            assert not response.is_closed
    ...
    def test_path_params_upsert(self, client: Micro) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `slug` but received ''"):
            client.prism.objects.organizations.with_raw_response.upsert(
                value="value",
                slug="",
            )
...
class TestAsyncOrganizations:
    ...
    async def test_method_update(self, async_client: AsyncMicro) -> None:
        organization = await async_client.prism.objects.organizations.update(
            organization_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
        assert_matches_type(OrganizationUpdateResponse, organization, path=["response"])
    ...
    async def test_raw_response_update(self, async_client: AsyncMicro) -> None:
        response = await async_client.prism.objects.organizations.with_raw_response.update(
            organization_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
    ...
    async def test_streaming_response_update(self, async_client: AsyncMicro) -> None:
        async with async_client.prism.objects.organizations.with_streaming_response.update(
            organization_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_update(self, async_client: AsyncMicro) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `organization_id` but received ''"):
            await async_client.prism.objects.organizations.with_raw_response.update(
                organization_id="",
            )
    ...
    async def test_method_list(self, async_client: AsyncMicro) -> None:
        organization = await async_client.prism.objects.organizations.list()
        assert_matches_type(OrganizationListResponse, organization, path=["response"])
    ...
    async def test_raw_response_list(self, async_client: AsyncMicro) -> None:
        response = await async_client.prism.objects.organizations.with_raw_response.list()
    ...
    async def test_streaming_response_list(self, async_client: AsyncMicro) -> None:
        async with async_client.prism.objects.organizations.with_streaming_response.list() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_method_delete(self, async_client: AsyncMicro) -> None:
        organization = await async_client.prism.objects.organizations.delete(
            organization_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
        assert organization is None
    ...
    async def test_raw_response_delete(self, async_client: AsyncMicro) -> None:
        response = await async_client.prism.objects.organizations.with_raw_response.delete(
            organization_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
    ...
    async def test_streaming_response_delete(self, async_client: AsyncMicro) -> None:
        async with async_client.prism.objects.organizations.with_streaming_response.delete(
            organization_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_delete(self, async_client: AsyncMicro) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `organization_id` but received ''"):
            await async_client.prism.objects.organizations.with_raw_response.delete(
                organization_id="",
            )
    ...
    async def test_method_bulk_delete(self, async_client: AsyncMicro) -> None:
        organization = await async_client.prism.objects.organizations.bulk_delete(
            ids=["182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e"],
        )
        assert_matches_type(OrganizationBulkDeleteResponse, organization, path=["response"])
    ...
    async def test_raw_response_bulk_delete(self, async_client: AsyncMicro) -> None:
        response = await async_client.prism.objects.organizations.with_raw_response.bulk_delete(
            ids=["182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e"],
        )
    ...
    async def test_streaming_response_bulk_delete(self, async_client: AsyncMicro) -> None:
        async with async_client.prism.objects.organizations.with_streaming_response.bulk_delete(
            ids=["182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e"],
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_method_bulk_update(self, async_client: AsyncMicro) -> None:
        organization = await async_client.prism.objects.organizations.bulk_update(
            items=[{"id": "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e"}],
        )
        assert_matches_type(OrganizationBulkUpdateResponse, organization, path=["response"])
    ...
    async def test_raw_response_bulk_update(self, async_client: AsyncMicro) -> None:
        response = await async_client.prism.objects.organizations.with_raw_response.bulk_update(
            items=[{"id": "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e"}],
        )
    ...
    async def test_streaming_response_bulk_update(self, async_client: AsyncMicro) -> None:
        async with async_client.prism.objects.organizations.with_streaming_response.bulk_update(
            items=[{"id": "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e"}],
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_method_count(self, async_client: AsyncMicro) -> None:
        organization = await async_client.prism.objects.organizations.count()
        assert_matches_type(OrganizationCountResponse, organization, path=["response"])
    ...
    async def test_raw_response_count(self, async_client: AsyncMicro) -> None:
        response = await async_client.prism.objects.organizations.with_raw_response.count()
    ...
    async def test_streaming_response_count(self, async_client: AsyncMicro) -> None:
        async with async_client.prism.objects.organizations.with_streaming_response.count() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_method_duplicate(self, async_client: AsyncMicro) -> None:
        organization = await async_client.prism.objects.organizations.duplicate(
            organization_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
        assert_matches_type(OrganizationDuplicateResponse, organization, path=["response"])
    ...
    async def test_raw_response_duplicate(self, async_client: AsyncMicro) -> None:
        response = await async_client.prism.objects.organizations.with_raw_response.duplicate(
            organization_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
    ...
    async def test_streaming_response_duplicate(self, async_client: AsyncMicro) -> None:
        async with async_client.prism.objects.organizations.with_streaming_response.duplicate(
            organization_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_duplicate(self, async_client: AsyncMicro) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `organization_id` but received ''"):
            await async_client.prism.objects.organizations.with_raw_response.duplicate(
                organization_id="",
            )
    ...
    async def test_method_find(self, async_client: AsyncMicro) -> None:
        organization = await async_client.prism.objects.organizations.find(
            value="value",
            slug="slug",
        )
        assert_matches_type(OrganizationFindResponse, organization, path=["response"])
    ...
    async def test_raw_response_find(self, async_client: AsyncMicro) -> None:
        response = await async_client.prism.objects.organizations.with_raw_response.find(
            value="value",
            slug="slug",
        )
    ...
    async def test_streaming_response_find(self, async_client: AsyncMicro) -> None:
        async with async_client.prism.objects.organizations.with_streaming_response.find(
            value="value",
            slug="slug",
        ) as response:
            assert not response.is_closed
    ...
    async def test_path_params_find(self, async_client: AsyncMicro) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `slug` but received ''"):
            await async_client.prism.objects.organizations.with_raw_response.find(
                value="value",
                slug="",
            )
    ...
    async def test_method_get(self, async_client: AsyncMicro) -> None:
        organization = await async_client.prism.objects.organizations.get(
            organization_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
        assert_matches_type(OrganizationGetResponse, organization, path=["response"])
    ...
    async def test_raw_response_get(self, async_client: AsyncMicro) -> None:
        response = await async_client.prism.objects.organizations.with_raw_response.get(
            organization_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
    ...
    async def test_streaming_response_get(self, async_client: AsyncMicro) -> None:
        async with async_client.prism.objects.organizations.with_streaming_response.get(
            organization_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_get(self, async_client: AsyncMicro) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `organization_id` but received ''"):
            await async_client.prism.objects.organizations.with_raw_response.get(
                organization_id="",
            )
    ...
    async def test_method_restore(self, async_client: AsyncMicro) -> None:
        organization = await async_client.prism.objects.organizations.restore(
            organization_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
        assert_matches_type(OrganizationRestoreResponse, organization, path=["response"])
    ...
    async def test_raw_response_restore(self, async_client: AsyncMicro) -> None:
        response = await async_client.prism.objects.organizations.with_raw_response.restore(
            organization_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
    ...
    async def test_streaming_response_restore(self, async_client: AsyncMicro) -> None:
        async with async_client.prism.objects.organizations.with_streaming_response.restore(
            organization_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_restore(self, async_client: AsyncMicro) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `organization_id` but received ''"):
            await async_client.prism.objects.organizations.with_raw_response.restore(
                organization_id="",
            )
    ...
    async def test_method_upsert(self, async_client: AsyncMicro) -> None:
        organization = await async_client.prism.objects.organizations.upsert(
            value="value",
            slug="slug",
        )
        assert_matches_type(OrganizationUpsertResponse, organization, path=["response"])
    ...
    async def test_raw_response_upsert(self, async_client: AsyncMicro) -> None:
        response = await async_client.prism.objects.organizations.with_raw_response.upsert(
            value="value",
            slug="slug",
        )
    ...
    async def test_streaming_response_upsert(self, async_client: AsyncMicro) -> None:
        async with async_client.prism.objects.organizations.with_streaming_response.upsert(
            value="value",
            slug="slug",
        ) as response:
            assert not response.is_closed
    ...
    async def test_path_params_upsert(self, async_client: AsyncMicro) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `slug` but received ''"):
            await async_client.prism.objects.organizations.with_raw_response.upsert(
                value="value",
                slug="",
            )
