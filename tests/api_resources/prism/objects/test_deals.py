...
class TestDeals:
    ...
    def test_method_create(self, client: Micro) -> None:
        ...
        assert_matches_type(PrismObjectProperties, deal, path=["response"])
    ...
    def test_raw_response_create(self, client: Micro) -> None:
        response = client.prism.objects.deals.with_raw_response.create()
    ...
    def test_streaming_response_create(self, client: Micro) -> None:
        with client.prism.objects.deals.with_streaming_response.create() as response:
    ...
    def test_raw_response_update(self, client: Micro) -> None:
        response = client.prism.objects.deals.with_raw_response.update(
            deal_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
    ...
    def test_streaming_response_update(self, client: Micro) -> None:
        with client.prism.objects.deals.with_streaming_response.update(
            deal_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_path_params_update(self, client: Micro) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `deal_id` but received ''"):
            client.prism.objects.deals.with_raw_response.update(
                deal_id="",
            )
    ...
    def test_raw_response_delete(self, client: Micro) -> None:
        response = client.prism.objects.deals.with_raw_response.delete(
            deal_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
    ...
    def test_streaming_response_delete(self, client: Micro) -> None:
        with client.prism.objects.deals.with_streaming_response.delete(
            deal_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_path_params_delete(self, client: Micro) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `deal_id` but received ''"):
            client.prism.objects.deals.with_raw_response.delete(
                deal_id="",
            )
    ...
    def test_method_bulk_create(self, client: Micro) -> None:
        deal = client.prism.objects.deals.bulk_create(
            objects=[{}],
        )
    ...
    def test_raw_response_bulk_create(self, client: Micro) -> None:
        response = client.prism.objects.deals.with_raw_response.bulk_create(
            objects=[{}],
        )
    ...
    def test_streaming_response_bulk_create(self, client: Micro) -> None:
        with client.prism.objects.deals.with_streaming_response.bulk_create(
            objects=[{}],
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_raw_response_duplicate(self, client: Micro) -> None:
        response = client.prism.objects.deals.with_raw_response.duplicate(
            deal_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
    ...
    def test_streaming_response_duplicate(self, client: Micro) -> None:
        with client.prism.objects.deals.with_streaming_response.duplicate(
            deal_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_path_params_duplicate(self, client: Micro) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `deal_id` but received ''"):
            client.prism.objects.deals.with_raw_response.duplicate(
                deal_id="",
            )
    ...
    def test_raw_response_get(self, client: Micro) -> None:
        response = client.prism.objects.deals.with_raw_response.get(
            deal_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
    ...
    def test_streaming_response_get(self, client: Micro) -> None:
        with client.prism.objects.deals.with_streaming_response.get(
            deal_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_path_params_get(self, client: Micro) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `deal_id` but received ''"):
            client.prism.objects.deals.with_raw_response.get(
                deal_id="",
            )
    ...
    def test_method_query(self, client: Micro) -> None:
        deal = client.prism.objects.deals.query(
            query={"select": ["string"]},
        )
    ...
    def test_streaming_response_restore(self, client: Micro) -> None:
        with client.prism.objects.deals.with_streaming_response.restore(
            deal_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_path_params_restore(self, client: Micro) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `deal_id` but received ''"):
            client.prism.objects.deals.with_raw_response.restore(
                deal_id="",
            )
...
class TestAsyncDeals:
    ...
    async def test_raw_response_create(self, async_client: AsyncMicro) -> None:
        response = await async_client.prism.objects.deals.with_raw_response.create()
    ...
    async def test_streaming_response_create(self, async_client: AsyncMicro) -> None:
        async with async_client.prism.objects.deals.with_streaming_response.create() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_method_update(self, async_client: AsyncMicro) -> None:
        deal = await async_client.prism.objects.deals.update(
            deal_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
        assert_matches_type(PrismObjectProperties, deal, path=["response"])
    ...
    async def test_raw_response_update(self, async_client: AsyncMicro) -> None:
        response = await async_client.prism.objects.deals.with_raw_response.update(
            deal_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
    ...
    async def test_streaming_response_update(self, async_client: AsyncMicro) -> None:
        async with async_client.prism.objects.deals.with_streaming_response.update(
            deal_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_update(self, async_client: AsyncMicro) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `deal_id` but received ''"):
            await async_client.prism.objects.deals.with_raw_response.update(
                deal_id="",
            )
    ...
    async def test_raw_response_delete(self, async_client: AsyncMicro) -> None:
        response = await async_client.prism.objects.deals.with_raw_response.delete(
            deal_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
    ...
    async def test_streaming_response_delete(self, async_client: AsyncMicro) -> None:
        async with async_client.prism.objects.deals.with_streaming_response.delete(
            deal_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_delete(self, async_client: AsyncMicro) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `deal_id` but received ''"):
            await async_client.prism.objects.deals.with_raw_response.delete(
                deal_id="",
            )
    ...
    async def test_method_bulk_create(self, async_client: AsyncMicro) -> None:
        deal = await async_client.prism.objects.deals.bulk_create(
            objects=[{}],
        )
        assert_matches_type(DealBulkCreateResponse, deal, path=["response"])
    ...
    async def test_raw_response_bulk_create(self, async_client: AsyncMicro) -> None:
        response = await async_client.prism.objects.deals.with_raw_response.bulk_create(
            objects=[{}],
        )
    ...
    async def test_streaming_response_bulk_create(self, async_client: AsyncMicro) -> None:
        async with async_client.prism.objects.deals.with_streaming_response.bulk_create(
            objects=[{}],
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_raw_response_duplicate(self, async_client: AsyncMicro) -> None:
        response = await async_client.prism.objects.deals.with_raw_response.duplicate(
            deal_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
    ...
    async def test_streaming_response_duplicate(self, async_client: AsyncMicro) -> None:
        async with async_client.prism.objects.deals.with_streaming_response.duplicate(
            deal_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_duplicate(self, async_client: AsyncMicro) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `deal_id` but received ''"):
            await async_client.prism.objects.deals.with_raw_response.duplicate(
                deal_id="",
            )
    ...
    async def test_raw_response_get(self, async_client: AsyncMicro) -> None:
        response = await async_client.prism.objects.deals.with_raw_response.get(
            deal_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
    ...
    async def test_streaming_response_get(self, async_client: AsyncMicro) -> None:
        async with async_client.prism.objects.deals.with_streaming_response.get(
            deal_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_get(self, async_client: AsyncMicro) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `deal_id` but received ''"):
            await async_client.prism.objects.deals.with_raw_response.get(
                deal_id="",
            )
    ...
    async def test_method_query(self, async_client: AsyncMicro) -> None:
        deal = await async_client.prism.objects.deals.query(
            query={"select": ["string"]},
        )
        assert_matches_type(DealQueryResponse, deal, path=["response"])
    ...
    async def test_raw_response_query(self, async_client: AsyncMicro) -> None:
        response = await async_client.prism.objects.deals.with_raw_response.query(
            query={"select": ["string"]},
        )
    ...
    async def test_streaming_response_query(self, async_client: AsyncMicro) -> None:
        async with async_client.prism.objects.deals.with_streaming_response.query(
            query={"select": ["string"]},
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_streaming_response_restore(self, async_client: AsyncMicro) -> None:
        async with async_client.prism.objects.deals.with_streaming_response.restore(
            deal_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
