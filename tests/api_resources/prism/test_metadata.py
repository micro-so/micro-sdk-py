...
class TestMetadata:
    ...
    def test_raw_response_list(self, client: Micro) -> None:
        response = client.prism.metadata.with_raw_response.list(
            object_type="deal",
        )
    ...
    def test_streaming_response_list(self, client: Micro) -> None:
        with client.prism.metadata.with_streaming_response.list(
            object_type="deal",
        ) as response:
...
class TestAsyncMetadata:
    ...
    async def test_raw_response_list(self, async_client: AsyncMicro) -> None:
        response = await async_client.prism.metadata.with_raw_response.list(
            object_type="deal",
        )
    ...
    async def test_streaming_response_list(self, async_client: AsyncMicro) -> None:
        async with async_client.prism.metadata.with_streaming_response.list(
            object_type="deal",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
