...
class TestOrganizations:
    ...
    def test_method_create(self, client: Micro) -> None:
        ...
        assert_matches_type(PrismObjectProperties, organization, path=["response"])
    ...
    def test_method_import(self, client: Micro) -> None:
        organization = client.organizations.import_(
            objects=[{}],
        )
        assert_matches_type(OrganizationImportResponse, organization, path=["response"])
    ...
    def test_raw_response_import(self, client: Micro) -> None:
        response = client.organizations.with_raw_response.import_(
            objects=[{}],
        )
    ...
    def test_streaming_response_import(self, client: Micro) -> None:
        with client.organizations.with_streaming_response.import_(
            objects=[{}],
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
...
class TestAsyncOrganizations:
    ...
    async def test_method_import(self, async_client: AsyncMicro) -> None:
        organization = await async_client.organizations.import_(
            objects=[{}],
        )
        assert_matches_type(OrganizationImportResponse, organization, path=["response"])
    ...
    async def test_raw_response_import(self, async_client: AsyncMicro) -> None:
        response = await async_client.organizations.with_raw_response.import_(
            objects=[{}],
        )
    ...
    async def test_streaming_response_import(self, async_client: AsyncMicro) -> None:
        async with async_client.organizations.with_streaming_response.import_(
            objects=[{}],
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
