...
def test_response_parse_mismatched_basemodel(client: Micro) -> None:
...
@pytest.mark.asyncio
async def test_async_response_parse_mismatched_basemodel(async_client: AsyncMicro) -> None:
...
def test_response_parse_custom_stream(client: Micro) -> None:
    response = APIResponse(
        raw=httpx.Response(200, content=b"foo"),
        client=client,
        stream=True,
...
@pytest.mark.asyncio
async def test_async_response_parse_custom_stream(async_client: AsyncMicro) -> None:
    response = AsyncAPIResponse(
        raw=httpx.Response(200, content=b"foo"),
        client=async_client,
        stream=True,
...
def test_response_parse_custom_model(client: Micro) -> None:
    response = APIResponse(
...
@pytest.mark.asyncio
async def test_async_response_parse_custom_model(async_client: AsyncMicro) -> None:
    response = AsyncAPIResponse(
        raw=httpx.Response(200, content=json.dumps({"foo": "hello!", "bar": 2})),
        client=async_client,
        stream=False,
...
def test_response_parse_annotated_type(client: Micro) -> None:
    response = APIResponse(
        raw=httpx.Response(200, content=json.dumps({"foo": "hello!", "bar": 2})),
        client=client,
        stream=False,
...
async def test_async_response_parse_annotated_type(async_client: AsyncMicro) -> None:
    response = AsyncAPIResponse(
        raw=httpx.Response(200, content=json.dumps({"foo": "hello!", "bar": 2})),
        client=async_client,
        stream=False,
...
def test_response_parse_bool(client: Micro, content: str, expected: bool) -> None:
    response = APIResponse(
...
async def test_async_response_parse_bool(client: AsyncMicro, content: str, expected: bool) -> None:
    response = AsyncAPIResponse(
        raw=httpx.Response(200, content=content),
        client=client,
        stream=False,
...
def test_response_parse_expect_model_union_non_json_content(client: Micro) -> None:
    response = APIResponse(
...
async def test_async_response_parse_expect_model_union_non_json_content(async_client: AsyncMicro) -> None:
    response = AsyncAPIResponse(
        raw=httpx.Response(200, content=b"foo", headers={"Content-Type": "application/text"}),
        client=async_client,
        stream=False,
