...
def _get_open_connections(client: Micro | AsyncMicro) -> int:
...
class TestMicro:
    ...
    def test_raw_response(self, respx_mock: MockRouter, client: Micro) -> None:
    ...
    @pytest.mark.respx(base_url=base_url)
    def test_raw_response_for_binary(self, respx_mock: MockRouter, client: Micro) -> None:
    ...
    def test_copy(self, client: Micro) -> None:
        copied = client.copy()
        ...
        copied = client.copy(team_id="another My Team ID")
        assert copied.team_id == "another My Team ID"
        assert client.team_id == "My Team ID"

    def test_copy_default_options(self, client: Micro) -> None:
    ...
    def test_copy_signature(self, client: Micro) -> None:
    ...
    def test_copy_build_request(self, client: Micro) -> None:
    ...
    def test_request_timeout(self, client: Micro) -> None:
        request = client._build_request(FinalRequestOptions(method="get", url="/foo"))
    ...
    def test_hardcoded_query_params_in_url(self, client: Micro) -> None:
    ...
    def test_request_extra_json(self, client: Micro) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_request_extra_headers(self, client: Micro) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_request_extra_query(self, client: Micro) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_multipart_repeating_array(self, client: Micro) -> None:
        request = client._build_request(
    ...
    @pytest.mark.respx(base_url=base_url)
    def test_binary_content_upload(self, respx_mock: MockRouter, client: Micro) -> None:
    ...
    @pytest.mark.respx(base_url=base_url)
    def test_binary_content_upload_with_body_is_deprecated(self, respx_mock: MockRouter, client: Micro) -> None:
        respx_mock.post("/upload").mock(side_effect=mirror_request_content)
    ...
    @pytest.mark.respx(base_url=base_url)
    def test_basic_union_response(self, respx_mock: MockRouter, client: Micro) -> None:
    ...
    @pytest.mark.respx(base_url=base_url)
    def test_union_response_different_types(self, respx_mock: MockRouter, client: Micro) -> None:
    ...
    @pytest.mark.respx(base_url=base_url)
    def test_non_application_json_content_type_for_json_data(self, respx_mock: MockRouter, client: Micro) -> None:
        """
    ...
    def test_base_url_setter(self) -> None:
        client = Micro(
            base_url="https://example.com/from_init", api_key=api_key, team_id=team_id, _strict_response_validation=True
        )
    ...
    def test_base_url_trailing_slash(self, client: Micro) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: Micro) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: Micro) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
    ...
    def test_copied_client_does_not_close_http(self) -> None:
        test_client = Micro(base_url=base_url, api_key=api_key, team_id=team_id, _strict_response_validation=True)
    ...
    @pytest.mark.respx(base_url=base_url)
    def test_client_response_validation_error(self, respx_mock: MockRouter, client: Micro) -> None:
        class Model(BaseModel):
            foo: str
    ...
    def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        strict_client = Micro(base_url=base_url, api_key=api_key, team_id=team_id, _strict_response_validation=True)

        with pytest.raises(APIResponseValidationError):
            strict_client.get("/foo", cast_to=Model)

        non_strict_client = Micro(
            base_url=base_url, api_key=api_key, team_id=team_id, _strict_response_validation=False
        )
    ...
    def test_parse_retry_after_header(
        self, remaining_retries: int, retry_after: str, timeout: float, client: Micro
    ) -> None:
    ...
    def test_retrying_timeout_errors_doesnt_leak(self, respx_mock: MockRouter, client: Micro) -> None:
        respx_mock.post("/v2/prism/My Team ID/deal").mock(side_effect=httpx.TimeoutException("Test timeout error"))

        with pytest.raises(APITimeoutError):
            client.prism.with_streaming_response.create_object(object_type="deal").__enter__()
    ...
    def test_retrying_status_errors_doesnt_leak(self, respx_mock: MockRouter, client: Micro) -> None:
        respx_mock.post("/v2/prism/My Team ID/deal").mock(return_value=httpx.Response(500))
    ...
    def test_retries_taken(
        ...
        respx_mock.post("/v2/prism/My Team ID/deal").mock(side_effect=retry_handler)

        response = client.prism.with_raw_response.create_object(object_type="deal")
    ...
    def test_omit_retry_count_header(self, client: Micro, failures_before_success: int, respx_mock: MockRouter) -> None:
        ...
        response = client.prism.with_raw_response.create_object(
            object_type="deal", extra_headers={"x-stainless-retry-count": Omit()}
        )
    ...
    def test_overwrite_retry_count_header(
        ...
        response = client.prism.with_raw_response.create_object(
            object_type="deal", extra_headers={"x-stainless-retry-count": "42"}
        )
    ...
    @pytest.mark.respx(base_url=base_url)
    def test_follow_redirects(self, respx_mock: MockRouter, client: Micro) -> None:
    ...
    @pytest.mark.respx(base_url=base_url)
    def test_follow_redirects_disabled(self, respx_mock: MockRouter, client: Micro) -> None:
...
class TestAsyncMicro:
    @pytest.mark.respx(base_url=base_url)
    async def test_raw_response(self, respx_mock: MockRouter, async_client: AsyncMicro) -> None:
        respx_mock.post("/foo").mock(return_value=httpx.Response(200, json={"foo": "bar"}))
    ...
    @pytest.mark.respx(base_url=base_url)
    async def test_raw_response_for_binary(self, respx_mock: MockRouter, async_client: AsyncMicro) -> None:
        respx_mock.post("/foo").mock(
            return_value=httpx.Response(200, headers={"Content-Type": "application/binary"}, content='{"foo": "bar"}')
        )
    ...
    def test_copy(self, async_client: AsyncMicro) -> None:
        ...
        copied = async_client.copy(team_id="another My Team ID")
        assert copied.team_id == "another My Team ID"
        assert async_client.team_id == "My Team ID"

    def test_copy_default_options(self, async_client: AsyncMicro) -> None:
        # options that have a default are overridden correctly
    ...
    def test_copy_signature(self, async_client: AsyncMicro) -> None:
        # ensure the same parameters that can be passed to the client are defined in the `.copy()` method
        init_signature = inspect.signature(
            # mypy doesn't like that we access the `__init__` property.
    ...
    @pytest.mark.skipif(sys.version_info >= (3, 10), reason="fails because of a memory leak that started from 3.12")
    def test_copy_build_request(self, async_client: AsyncMicro) -> None:
        options = FinalRequestOptions(method="get", url="/foo")
    ...
    async def test_request_timeout(self, async_client: AsyncMicro) -> None:
    ...
    async def test_hardcoded_query_params_in_url(self, async_client: AsyncMicro) -> None:
    ...
    def test_multipart_repeating_array(self, async_client: AsyncMicro) -> None:
        request = async_client._build_request(
            FinalRequestOptions.construct(
                method="post",
                url="/foo",
    ...
    @pytest.mark.respx(base_url=base_url)
    async def test_binary_content_upload(self, respx_mock: MockRouter, async_client: AsyncMicro) -> None:
        respx_mock.post("/upload").mock(side_effect=mirror_request_content)
    ...
    async def test_binary_content_upload_with_body_is_deprecated(
        self, respx_mock: MockRouter, async_client: AsyncMicro
    ) -> None:
        respx_mock.post("/upload").mock(side_effect=mirror_request_content)
    ...
    @pytest.mark.respx(base_url=base_url)
    async def test_basic_union_response(self, respx_mock: MockRouter, async_client: AsyncMicro) -> None:
        class Model1(BaseModel):
            name: str
    ...
    @pytest.mark.respx(base_url=base_url)
    async def test_union_response_different_types(self, respx_mock: MockRouter, async_client: AsyncMicro) -> None:
        """Union of objects with the same field name using a different type"""
    ...
    async def test_base_url_trailing_slash(self, client: AsyncMicro) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    async def test_base_url_no_trailing_slash(self, client: AsyncMicro) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    async def test_absolute_request_url(self, client: AsyncMicro) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="https://myapi.com/foo",
    ...
    async def test_copied_client_does_not_close_http(self) -> None:
        test_client = AsyncMicro(base_url=base_url, api_key=api_key, team_id=team_id, _strict_response_validation=True)
        assert not test_client.is_closed()
    ...
    @pytest.mark.respx(base_url=base_url)
    async def test_client_response_validation_error(self, respx_mock: MockRouter, async_client: AsyncMicro) -> None:
        class Model(BaseModel):
            foo: str
    ...
    async def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        strict_client = AsyncMicro(
            base_url=base_url, api_key=api_key, team_id=team_id, _strict_response_validation=True
        )

        with pytest.raises(APIResponseValidationError):
            await strict_client.get("/foo", cast_to=Model)

        non_strict_client = AsyncMicro(
            base_url=base_url, api_key=api_key, team_id=team_id, _strict_response_validation=False
        )
    ...
    async def test_parse_retry_after_header(
        self, remaining_retries: int, retry_after: str, timeout: float, async_client: AsyncMicro
    ) -> None:
        headers = httpx.Headers({"retry-after": retry_after})
        options = FinalRequestOptions(method="get", url="/foo", max_retries=3)
    ...
    async def test_retrying_timeout_errors_doesnt_leak(self, respx_mock: MockRouter, async_client: AsyncMicro) -> None:
        ...
        with pytest.raises(APITimeoutError):
            await async_client.prism.with_streaming_response.create_object(object_type="deal").__aenter__()
    ...
    async def test_retries_taken(
        ...
        response = await client.prism.with_raw_response.create_object(object_type="deal")
    ...
    async def test_omit_retry_count_header(
        ...
        response = await client.prism.with_raw_response.create_object(
            object_type="deal", extra_headers={"x-stainless-retry-count": Omit()}
        )
    ...
    @pytest.mark.respx(base_url=base_url)
    async def test_follow_redirects(self, respx_mock: MockRouter, async_client: AsyncMicro) -> None:
        # Test that the default follow_redirects=True allows following redirects
        respx_mock.post("/redirect").mock(
            return_value=httpx.Response(302, headers={"Location": f"{base_url}/redirected"})
        )
    ...
    @pytest.mark.respx(base_url=base_url)
    async def test_follow_redirects_disabled(self, respx_mock: MockRouter, async_client: AsyncMicro) -> None:
        # Test that follow_redirects=False prevents following redirects
        respx_mock.post("/redirect").mock(
            return_value=httpx.Response(302, headers={"Location": f"{base_url}/redirected"})
        )
